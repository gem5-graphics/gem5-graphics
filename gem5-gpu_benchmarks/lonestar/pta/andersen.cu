...
__host__ void addTimeToRule(double& counter, double& startTime)
{
    double ellapsedTime = (rtclock() - startTime);
...
extern "C" void createGraph(const uint numObjectVars, const uint maxOffset)
{
    ...
    const double startTime = rtclock();
...
extern "C" uint andersen(uint numVars)
{
    ...
    const double startTime = rtclock();
    uint iteration = 0;
    double updatePtsTime = 0;
    double hcdTime = 0;
    double ptsEquivTime = 0;
    double copyInvTime = 0;
    double storeInvTime = 0;
    double gepInvTime = 0;
    ...
    double solveTime = getEllapsedTime(startTime);
    printf("SOLVE runtime: %f s.\n", createTime + solveTime);
    printf("    create graph    : %f s.\n", createTime);
    printf("    rule solving    : %f s.\n", solveTime);
    printf("        updatePts   : %f s.\n", updatePtsTime);
    printf("        hcd         : %f s.\n", hcdTime);
    printf("        equiv       : %f s.\n", ptsEquivTime);
    printf("        cpLdSt2inv  : %f s.\n", copyInvTime);
    printf("        store       : %f s.\n", storeInvTime);
    printf("        gepInv      : %f s.\n", gepInvTime);
