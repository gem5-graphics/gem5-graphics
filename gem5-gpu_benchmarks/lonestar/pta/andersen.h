...
__host__ inline double getEllapsedTime(const double& startTime)
{
    //TODO: this code should depend on whether it is executing on the GPU or the CPU
    return (rtclock() - startTime);
}

//__device__ inline double getEllapsedTime(const double& startTime)
//{
//    //TODO: this code should depend on whether it is executing on the GPU or the CPU
//    return (1000.0f * (clock() - startTime) / CLOCKS_PER_SEC);
//}
