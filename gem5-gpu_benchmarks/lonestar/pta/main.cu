...
static double transferH2dTime = 0.0;
static double transferD2hTime = 0.0;
...
void transferBackInfo(uint verify, uint numVars, uint* edgesD, uint ptsSize, uint* repD, char* solFile)
{
    ...
    cerr << "OK." << endl << flush;
    cout << "TRANSFER runtime: "  << (transferH2dTime + transferD2hTime) << " s." << endl;
    cout << "    h2d: " << transferH2dTime << " s." << endl;
    cout << "    d2h: " << transferD2hTime << " s." << endl;
