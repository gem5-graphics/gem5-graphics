...
int main(int argc, char* argv[])
{
   ...
   printf("TWO_LEVEL_NODE_TREE is %d\n", TWO_LEVEL_NODE_TREE);
   printf("TWO_LEVEL_CHILD_TREE is %d\n", TWO_LEVEL_CHILD_TREE);
   printf("QRYTEX is %d\n", QRYTEX);
   printf("COALESCED_QUERIES is %d\n", COALESCED_QUERIES);
   printf("REFTEX is %d\n", REFTEX);
   printf("REORDER_REF is %d\n", REORDER_REF);
   printf("NODETEX is %d\n", NODETEX);
   printf("CHILDTEX is %d\n", CHILDTEX);
   printf("MERGETEX is %d\n", MERGETEX);
   printf("REORDER_TREE is %d\n", REORDER_TREE);
	printf("RENUMBER_TREE is %d\n", RENUMBER_TREE);
