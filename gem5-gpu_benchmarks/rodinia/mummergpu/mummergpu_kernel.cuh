...
__device__ int addr2id(unsigned int addr)
{
 ...
 __device__ TextureAddress id2addr_d(int id)
 {
...
__device__ _PixelOfNodeNoData getNodeNoData(unsigned int cur,
                          bool use_two_level
#if !NODETEX
                          , _PixelOfNode* nodes
#endif
...
#if REORDER_TREE
  return *(_PixelOfNodeNoData*)(nodes + (cur & 0x0000FFFF) + (((cur & 0xFFFF0000)>>16) * MAX_TEXTURE_DIMENSION));
#else
  return *(_PixelOfNodeNoData*)(nodes + cur);
#endif
#endif
}
...
__device__ _PixelOfChildrenNoData getChildrenNoData(unsigned int cur,
                              bool use_two_level
#if !CHILDTEX
                          , _PixelOfChildren* childrenarr
#endif
...
#else
#if REORDER_TREE
  return *(_PixelOfChildrenNoData*)(childrenarr +  (cur & 0x0000FFFF) + (((cur & 0xFFFF0000)>>16) * MAX_TEXTURE_DIMENSION));
#else
  return *(_PixelOfChildrenNoData*)(childrenarr + cur);
#endif
#endif
}
...
__device__ _PixelOfChildrenNoDataBasesOnly getChildrenNoDataBasesOnly(unsigned int cur,
                              bool use_two_level
#if !CHILDTEX
                          , _PixelOfChildren* childrenarr
#endif
...
#else
#if REORDER_TREE
  return *(_PixelOfChildrenNoDataBasesOnly*)(childrenarr +  (cur & 0x0000FFFF) + (((cur & 0xFFFF0000)>>16) * MAX_TEXTURE_DIMENSION));
#else
  return *(_PixelOfChildrenNoDataBasesOnly*)(childrenarr + cur);
#endif
#endif
}
...
{
  TextureAddress addr = id2addr_d(nodeid);
            ...
            )
{
  ...
  _PixelOfNodeNoData node;
  node = getNodeNoData(cur, true, nodes);
  ...
  node = getNodeNoData(printParent, true, nodes);
  ...
  if (printParent == matchaddr)
  {
    ...
    {
      node = getNodeNoData(badParent, true, nodes);
  ...
  while (cur != badParent)
  {
    _PixelOfChildrenNoData children123;
    children123 = getChildrenNoData(cur, true, childrenarr);
    char isLeaf = children123.leafchar;
    ...
    if (isLeaf || forceToParent)
    {
      ...
      {
        int leafid = MKI(children123.leafid);
      ...
      _PixelOfChildrenNoData pchildren;
      pchildren = getChildrenNoData(myParent, true, childrenarr);
    ...
    else
    {
      ...
      _PixelOfChildrenNoDataBasesOnly children456;
      children456 = getChildrenNoDataBasesOnly(cur, true, childrenarr);
      ...
      do
      {
        if (curchild == 'A')
        {
          if (children456.a.x || children456.a.y || children456.a.z)
          {
            XPRINTF("  -> A\n");
            arrayToAddress(children456.a, cur);
            break;
          }
        ...
        if (curchild == 'C')
        {
          if (children456.c.x || children456.c.y || children456.c.z)
          {
            XPRINTF("  -> C\n");
            arrayToAddress(children456.c, cur);
            break;
          }
          curchild = 'G';
        }
        ...
        if (curchild == 'G')
        {
          if (children456.g.x || children456.g.y || children456.g.z)
          {
            XPRINTF("  -> G\n");
            arrayToAddress(children456.g, cur);
            break;
          }
          curchild = 'T';
        }
        ...
        if (curchild == 'T')
        {
          if (children456.t.x || children456.t.y || children456.t.z)
          {
            XPRINTF("  -> T\n");
            arrayToAddress(children456.t, cur);
            break;
          }
          curchild = '$';
        }
        ...
        if (curchild == '$')
        {
          if (children456.d.x || children456.d.y || children456.d.z)
          {
            XPRINTF("  -> $\n");
            arrayToAddress(children456.d, cur);
            break;
          }
        }
          ...
          if (curchild == goldenChild)
          {
            ...
            if (cur == matchaddr)
            {
              ...
              if (matches[matchid].edgematch > 0)
              {
                ...
                node = getNodeNoData(par, true, nodes);
                matchlen = MKI(node.depth) - 1 + matches[matchid].edgematch;
              }
            }
          }
