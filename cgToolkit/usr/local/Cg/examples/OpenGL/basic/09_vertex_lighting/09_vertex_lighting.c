...
static const char *myProgramName = "09_vertex_lighting",
                  *myVertexProgramFileName = "C5E1v_basicLight.cg",
...
static void setBrassMaterial(void)
{
  ...
  cgSetParameter3fv(myCgVertexParam_Ke, brassEmissive);
  cgSetParameter3fv(myCgVertexParam_Ka, brassAmbient);
  cgSetParameter3fv(myCgVertexParam_Kd, brassDiffuse);
  cgSetParameter3fv(myCgVertexParam_Ks, brassSpecular);
  cgSetParameter1f(myCgVertexParam_shininess, brassShininess);
}
...
static void setRedPlasticMaterial(void)
{
  ...
  cgSetParameter3fv(myCgVertexParam_Ke, redPlasticEmissive);
  checkForCgError("setting Ke parameter");
  cgSetParameter3fv(myCgVertexParam_Ka, redPlasticAmbient);
  checkForCgError("setting Ka parameter");
  cgSetParameter3fv(myCgVertexParam_Kd, redPlasticDiffuse);
  checkForCgError("setting Kd parameter");
  cgSetParameter3fv(myCgVertexParam_Ks, redPlasticSpecular);
  checkForCgError("setting Ks parameter");
  cgSetParameter1f(myCgVertexParam_shininess, redPlasticShininess);
...
static void setEmissiveLightColorOnly(void)
{
  ...
  cgSetParameter3fv(myCgVertexParam_Ke, myLightColor);
  checkForCgError("setting Ke parameter");
  cgSetParameter3fv(myCgVertexParam_Ka, zero);
  checkForCgError("setting Ka parameter");
  cgSetParameter3fv(myCgVertexParam_Kd, zero);
  checkForCgError("setting Kd parameter");
  cgSetParameter3fv(myCgVertexParam_Ks, zero);
  checkForCgError("setting Ks parameter");
  cgSetParameter1f(myCgVertexParam_shininess, 0);
  checkForCgError("setting shininess parameter");
}
...
static void display(void)
{
  ...
  cgSetParameter3f(myCgVertexParam_lightPosition, 0,0,0);
