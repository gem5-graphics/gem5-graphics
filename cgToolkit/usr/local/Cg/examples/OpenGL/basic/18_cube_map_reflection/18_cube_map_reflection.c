...
/* 18_cube_map_reflection.c - OpenGL-based reflective environment
   mapping example using Cg program from Chapter 7 of "The Cg Tutorial"
...
static CGparameter myCgVertexParam_modelViewProj,
                   ...
                   myCgFragmentParam_reflectivity,
                   myCgFragmentParam_decalMap,
                   myCgFragmentParam_environmentMap;

static const char *myProgramName = "18_cube_map_reflection",
                  *myVertexProgramFileName = "C7E1v_reflection.cg",
/* Page 177 */    *myVertexProgramName = "C7E1v_reflection",
                  *myFragmentProgramFileName = "C7E2f_reflection.cg",
/* Page 180 */    *myFragmentProgramName = "C7E2f_reflection";
...
#define GET_PARAM(name) \
  ...
  checkForCgError("could not get reflectivity parameter");
  cgSetParameter1f(myCgFragmentParam_reflectivity, reflectivity);
  ...
  glutAddMenuEntry("[+] Increase reflectivity", ' ');
  glutAddMenuEntry("[-] Decrease reflectivity", ' ');
