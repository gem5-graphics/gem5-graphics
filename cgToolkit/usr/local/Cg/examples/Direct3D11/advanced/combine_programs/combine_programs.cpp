...
static const TCHAR * myProgramName             = L"combine_programs";
...
HRESULT InitCg()
{
    ...
    cgD3D11UnloadProgram( myCgVertexProgram );
    cgD3D11UnloadProgram( myCgFragmentProgram );
    cgDestroyProgram( myCgVertexProgram );
    cgDestroyProgram( myCgFragmentProgram );

    // Load new combined program with matched signatures
    cgD3D11LoadProgram( myCgCombinedProgram, 0 );   
...
void Render()
{
    ...
    cgD3D11BindProgram( myCgCombinedProgram );
