...
/* cgfx_bumpdemo_array.c - a Direct3D11-based Cg 3.0 demo */
...
int selectValue[7] = { 0, 0, 0, 0, 0, 0, 0 };
int selectMax   = 0;
int selectIndex = 0;
int selectTest  = 0;

const TCHAR * myProgramName  = L"cgfx_bumpdemo_array";
const char *  myCgFXFileName = "bumpdemo_array.cgfx"; // Use char here since that's what the Cg runtime expects
...
HRESULT InitCg()
{
    ...
    if( myCgTechnique)
    {
        for( int i=0; i < sizeof( selectValue ) / sizeof( int ); ++i )
        {
