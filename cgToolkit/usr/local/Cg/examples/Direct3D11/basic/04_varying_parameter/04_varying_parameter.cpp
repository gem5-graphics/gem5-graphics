...
/* 04_varying_parameter.c - Direct3D11-based varying parameter example
...
float ClearColor[4] = { 0.1f, 0.3f, 0.6f, 0.0f }; // RGBA
...
static const WCHAR * myProgramName             = L"04_varying_parameter";
static const char  * myVertexProgramFileName   = "C3E2v_varying.cg",
