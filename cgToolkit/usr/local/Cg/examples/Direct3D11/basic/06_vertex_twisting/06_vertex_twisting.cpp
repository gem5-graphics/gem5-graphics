...
/* 06_vertex_twisting.c - Direct3D11-based vertex twisting example
...
static const WCHAR * myProgramName             = L"06_vertex_twisting";
static const char  * myVertexProgramFileName   = "C3E4v_twist.cg",
...
HRESULT InitCg()
{
    ...
    myCgVertexParam_twisting = cgGetNamedParameter( myCgVertexProgram, "twisting" );
...
void Render()
{
    ...
    g_pDeviceContext->Draw( myNumTriangles * 3, 0 ); // numVertices, startVertex
