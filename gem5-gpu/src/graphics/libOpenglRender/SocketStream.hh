...
public:
    ...
    static void incSockets(uint64_t m_sock);
    static void incReadySockets(int sock, bool uncond);
    static void decReadySockets(int sock, bool uncond);
    static void incPendingBytes(size_t bytes, int sock);
    static void decPendingBytes(size_t bytes, int sock);
...
protected:
    ...
    static size_t m_pendingRenderBytes;
    static std::mutex m_sockCount;
    static std::map<int, bool> m_renderSockets;
