...
struct emugl_sync_create_timeline_t;
struct emugl_sync_create_fence_t;
struct emugl_sync_timeline_inc_t;
struct emugl_sync_destroy_timeline_t;
struct emugl_sync_register_trigger_wait_t;
struct emugl_sync_device_exists_t;
struct emugl_dma_ops;
